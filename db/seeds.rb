...
item1 = Item.create!(user: user1, name: "Cute table from 1950s", color: "pink", category: "table", shipping: "from home", price: 53, description: "wonderful bed")
...
item2 = Item.create!(user: user1, name: "Ugly armchair from France", color: "yellow", category: "armchair", shipping: "from home", price: 13, description: "wonderful armchair")
...
item3 = Item.create!(user: user1, name: "Bookcase from IKEA", color: "white", category: "bookcase", shipping: "from home", price: 45, description: "wonderful bookcase")
...
item4 = Item.create!(user: user1, name: "Luxury carpet from Iran", color: "green", category: "carpet", shipping: "from home", price: 59, description: "wonderful carpet")
...
item5 = Item.create!(user: user1, name: "Beautiful coffee table", color: "black", category: "table", shipping: "from home", price: 155, description: "isdhfhsdfu")
...
item6 = Item.create!(user: user1, name: "Wooden stool", color: "brown", category: "chair", shipping: "from home", price: 27, description: "sdfsdfsdfsdf")
...
item7 = Item.create!(user: user1, name: "Chairs x4", color: "wood", category: "chair", shipping: "from home", price: 35, description: "sdfdsfsdfdsfd")
...
item8 = Item.create!(user: user1, name: "Console table for entryway", color: "gold", category: "table", shipping: "from home", price: 95, description: "sdfsdfsdfsdf")
...
item9 = Item.create!(user: user1, name: "Chesterfield faux-leather sofa", color: "orange", category: "sofa", shipping: "from home", price: 56, description: "sfsfsfddfs")
...
item10 = Item.create!(user: user2, name: "Dining table", color: "purple", category: "table", shipping: "from home", price: 50, description: "sdfsdfsdf")
