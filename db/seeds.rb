...
item1 = Item.create(user: user2, name: "Cute table from 1950s", color: "Pink", category: "Table", shipping: "delivery to the renter", price: 53, description: "wonderful bed")
...
item2 = Item.create(user: user1, name: "Ugly armchair from France", color: "Yellow", category: "Armchair", shipping: "collection from the owner", price: 13, description: "wonderful armchair")
...
item3 = Item.create(user: user2, name: "Bookcase from IKEA", color: "White", category: "Bookcase", shipping: "delivery to the renter", price: 45, description: "wonderful bookcase")
...
item4 = Item.create(user: user2, name: "Luxury carpet from Iran", color: "Green", category: "Carpet", shipping: "delivery to the renter", price: 59, description: "wonderful carpet")
...
item5 = Item.create(user: user4, name: "Beautiful coffee table", color: "Black", category: "Table", shipping: "collection from the owner", price: 155, description: "isdhfhsdfu")
...
item6 = Item.create(user: user1, name: "Wooden stool", color: "Brown", category: "Chair", shipping: "flexible", price: 27, description: "sdfsdfsdfsdf")
...
item7 = Item.create(user: user3, name: "Chairs x4", color: "Light wood", category: "Chair", shipping: "collection from the owner", price: 35, description: "sdfdsfsdfdsfd")
...
item8 = Item.create(user: user5, name: "Console table for entryway", color: "Gold", category: "Table", shipping: "flexible", price: 95, description: "sdfsdfsdfsdf")
...
item9 = Item.create(user: user2, name: "Chesterfield faux-leather sofa", color: "Orange", category: "Sofa", shipping: "delivery to the renter", price: 56, description: "sfsfsfddfs")
...
item10 = Item.create(user: user2, name: "Dining table", color: "Purple", category: "Table", shipping: "collection from the owner", price: 50, description: "sdfsdfsdf")
